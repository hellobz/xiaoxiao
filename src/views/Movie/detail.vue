<template>
  <div id="detailContainer" class="slide_enter_left">
    <Header title="影片详情">
      <i class="iconfont icon-right" @touchstart="handleGoBack"></i>
    </Header>
    ...
    <div v-else id="content" class="contentDetail">
      ...
      <div class="detail_player swiper-container" ref="detail_player">
        <ul class="swiper-wrapper">
          <li
            class="swiper-slide"
            v-for="(wiperItem, wiperIndex) in detailMovie.photos"
            :key="wiperIndex"
          >
            <div>
              <img :src="wiperItem | setWH('880.1207')" alt="" />
            </div>
          </li>
        </ul>
      </div>
...
#detailContainer.slide_enter_left {
